...
public class Constants {
	public static final String[] IMAGES = new String[] {
			...
			"drawable://" + R.drawable.ic_core_overflow, // Image from drawables
	...
	// public static String ScheduleSUCCESS = "Success";
	...
	// "http://10.10.10.134/VMS/WS.asmx/AppointmentSearch";
	public static final String TAG_search = "d";
	public static final String TAG_searchFlag = "Flag";
	public static final String TAG_searchMsg = "Mesg";
	public static final String TAG_searchName = "Name";
	public static final String TAG_searchAppwith = "AppointmentWith";
	public static final String TAG_searchDept = "Department";
	public static final String TAG_searchDate = "AppointmentDate";
	public static final String TAG_searchstartTime = "AppointmentStartTime";
	public static final String TAG_searchEndTime = "AppointmentEndTime";
	public static final String TAG_searchStatue = "AppointmentStatus";
	public static final String TAG_searchappID = "AppointmentID";
	public static final String TAG_searchcatId = "CategoryID";
	public static final String TAG_searchEmail = "Email";
	public static final String TAG_searchPhone = "PhoneNumber";
	// public static String WS_URL =
	// "http://10.10.10.100/rEventServices/rEventDev.asmx/";
	// public static String WS_URL =
	// "http://10.10.10.134/rEventServices/rEventDev.asmx/";
	// public static String WS_URL =
	// "http://10.10.10.52/rEventServices/rEventDev.asmx/";
	// public static String WS_URL =
	// "http://10.10.10.52/rEvent/reventWeb.asmx/";
	public static String WS_URL = "http://111.90.171.125/rEvent/reventWeb.asmx/";

	public static String WS_URL_LOGIN = WS_URL + "CheckLogin";
	public static String WS_URL_GETALLEVENTS = WS_URL + "GetAllEvents";
	public static String WS_URL_GETCOMPANYWISEEVENTS = WS_URL
			+ "GetCompanyWiseEvents";
	public static String WS_URL_GETEVENTPDF = WS_URL + "GetEventPDF";
	public static String WS_URL_GETRECEIPT = WS_URL + "GetReceipt";
	
	public static String WS_URL_GETVANUEDETAILS = WS_URL + "GetVanueDetails";
	public static String WS_URL_GETBADGEDETAILS = WS_URL
			+ "GetRegistrationsByBarcode";
	public static String WS_URL_GETBADGEDETAIL = WS_URL + "GetBadgeDetail";
	// public static String WS_URL_GETBADGEDETAIL = WS_URL + "GetBadgeDetails";
	public static String WS_URL_GETCHECKCREDENTIALS = WS_URL
			+ "CheckCredentials";
	public static String WS_URL_GETSERVICES = WS_URL + "GetServices";
	public static String WS_URL_GETUSERPROFILE = WS_URL + "GetUserProfile";
	public static String WS_URL_GETFORGOTPASSWORD = WS_URL + "ForgotPassword";
	public static String WS_URL_VISITOR_REGISTRATION = WS_URL
			+ "VisitorRegistration";
	public static String WS_URL_CATEGORY_URL = WS_URL
			+ "GetAppointmentSchedule";
	public static String WS_URL_DEPARTMENT_LIST = WS_URL
			+ "GetAppointmentSchedule_ListofDepartments";
	public static String WS_URL_EMPLOYEE_LIST = WS_URL
			+ "GetAppointmentSchedule_ListofEmployees";
	public static String WS_URL_SCHEDULED_APPOINTMENTS = WS_URL
			+ "EmployeeAppointments";
	public static String WS_URL_APPOINTMENTSEARCH = WS_URL
			+ "AppointmentSearch";
	public static String WS_URL_GETUNASSIGNBADGE = WS_URL + "GetUnAssignBadge";
	public static String WS_URL_GUESTTRACKING = WS_URL
			+ "GuestAppointment_TrackingDetail";
	public static String WS_URL_GUESTTRACKING_INSERT = WS_URL
			+ "GuestTracking_Insert";
	public static String WS_URL_GETAPPOINTMENTSCHEDULE_INSERTAPPOINTMENT = WS_URL
			+ "GetAppointmentSchedule_InsertAppointment";
	public static String WS_URL_GETAPPOINTMENTSCHEDULE_INSERTINTERNALAPPOINTMENT = WS_URL
			+ "InsertInternalAppointment";
	public static String WS_URL_GETAPPOINTMENTSCHEDULE_INSERTEXTERNALAPPOINTMENT = WS_URL
			+ "InsertExternalAppointment";
	public static String WS_URL_GETALLDEPARTMENT = WS_URL + "GetAllDepartment";
	public static String WS_URL_GETALLEMPLOYEE = WS_URL
			+ "GetAllPersonByDepartment";
	public static String WS_URL_UPDATEAPPOINTMENTSTATUS = WS_URL
			+ "UpdateAppointmentStatus";
	public static String WS_URL_UPDATEGETAPPOINTMENTSEARCH = WS_URL
			+ "GetAppointmentSearch";

	/* Registration */
	public static final String TAG_Rgs = "d";
	public static final String TAG_RgsBedge = "Badge_No";
	public static String SEARCHSUCCESS = "Success";
	public static String SEARCHMSG = "Success";
	public static final int SERVICE_TIME_OUT = 60000;

	public static String CONNECTIVITY_ERROR_MESSAGE = "No internet connection. Please turn on mobile or wifi connection from settings";
	public static String SERVICE_ERROR_MESSAGE = "No service available at the moment. Try again later.";
	public static String SERVICE_ERROR_TITLE = "Service error";
	public static String CONNECTIVITY_ERROR_TITLE = "Connectivity error";

	public static final String REGISTRATION_COMPLETE = "registrationComplete";

	public static boolean validateString(String object) {
		boolean flag = false;
		Log.e("String", "String Length : " + object.trim().length());
	...
	public static boolean validatePhoneNumber(String object) {
		boolean flag = false;
		Log.e("String", "Phone Number Length : " + object.trim().length());
		// if (object != null && !object.isEmpty()
		// && object.equalsIgnoreCase("null") != true
		// && object.trim().length() > 0
		// && !object.equalsIgnoreCase("(null)")) {
		// flag = true;
		// }
		if (object.trim().length() > 7 && object.trim().length() < 15) {
			flag = true;
		}
		return flag;
	}
	...
	public static void isLogout(Context c) {
